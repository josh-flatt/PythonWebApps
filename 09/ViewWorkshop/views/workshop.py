...
def document_card(document):
    ...
    return dict(
        ...
        file=document,
        color="bg-primary text-light p-5",
        width="",
        link=link,
    )
...
def carousel_data():
    return [
        dict(
            image_url="https://source.unsplash.com/random/1200x800?bear",
            label="Bear",
            active="active",
        ),
        dict(
            image_url="https://source.unsplash.com/random/1200x800?forest",
            label="Forest",
        ),
        dict(
            image_url="https://source.unsplash.com/random/1200x800?ocean", label="Ocean"
        ),
        dict(
            image_url="https://source.unsplash.com/random/1200x800?flower",
            label="Flower",
        ),
    ]
